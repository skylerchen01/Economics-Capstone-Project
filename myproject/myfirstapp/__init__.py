...
class MyPage(Page):
    form_model = "player"
    form_fields = ['gender', 'major', 'born', 'school']
...
class BlockPage2(Page):
    ...
    def vars_for_template(player):
        import random
        questions = random.choice(B.questions)
        title = questions.pop(0)
        title = title.split("-")
...
class ResultsAB_f(Page):
    ...
    def is_displayed(player: Player):
        return (player.flag == "A" or player.flag == "B") and player.title1!='今天'
...
class ResultsC_f(Page):
    ...
    def is_displayed(player: Player):
        return player.flag == "C" and player.title1!='今天'
...
# notice, adapt, adapt2,
#
page_sequence = [  notice, adapt, adapt2, adapt3, adapt4, BlockPage1] + [BlockPage] * len(BLOCKS) + [BlockPage2, audio1,audio,
                                                                                                  audio2,

                                                                                                   WorkPage1, WorkPage,
                                                                                                   WorkPage2,
                                                                                                   MyPage,ResultsAB_t,ResultsAB_f,ResultsC_f,ResultsC_t]
